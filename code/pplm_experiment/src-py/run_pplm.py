...
DISCRIMINATOR_MODELS_PARAMS = {
    ...
    "belief": {
        "url": "/workspace/ceph_data/belief-based-argumentation-generation/experiments/pplm_experiment/output/models/discrim_model/belief_discrim_classifier_head_epoch_10.pt",
        "class_size": 3,
        "embed_size": 1024,
        "class_vocab": {"left": 0, "moderate": 1, "right":2},
        "default_class": 0,
        "pretrained_model": "gpt2-medium",
    }
}
...
def generate_text_pplm(
    ...
    #for i in trange(length, ascii=True):
        ...
        pred_tokens = output_so_far.tolist()[0]
        last_token = pred_tokens[-1]
        if len(pred_tokens) > max_length or (last_token == PERIOD_TOKEN_ID and len(pred_tokens) > length):
            break
...
def set_generic_model_params(discrim_weights, discrim_meta):
    ...
    with open(discrim_meta, "r", encoding='utf-8') as discrim_meta_file:
